...
class SupportOperations(commands.Cog):
    ...
    async def show_about_menu(self, interaction: discord.Interaction):
        ...
        about_embed = discord.Embed(
            title=f"{theme.infoIcon} About Police Chief Bot",
            description=(
                f"**Discord Bot for Police Chief**\n"
                f"{theme.upperDivider}\n"
                f"This bot helps manage alliances, members, and events for the "
                f"Police Chief mobile game.\n\n"
                f"{theme.linkIcon} **Source & Documentation:**\n"
                f"https://github.com/lynxexp/police-chief-project\n\n"
            ),
            color=discord.Color.green()
        )

        about_embed.set_footer(text=f"Police Chief Bot {theme.heartIcon}")
    ...
    async def show_support_info(self, interaction: discord.Interaction):
        support_embed = discord.Embed(
            ...
            description=(
                ...
                "please contact your server's bot administrator.\n\n"
                "For technical support, please make sure to provide "
                "detailed information about your problem, including any error "
                "messages and the steps that led to it."
            ),
