...
def _get_ready_messages():
    ...
    try:
        ...
        return [
            f"{theme.startupGiftIcon} Ready to blast every gift code to the crew the second it drops!",
            ...
            f"{theme.startupCashIcon} Morally bankrupt, but first with every gift code drop. Let's do this!",
        ]
    except Exception:
        return [
            "🎁 Ready to blast every gift code to the crew the second it drops!",
            ...
            "💸 Morally bankrupt, but first with every gift code drop. Let's do this!",
        ]
