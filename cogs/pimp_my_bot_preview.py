...
class ThemePreviewView(discord.ui.View):
    ...
    def build_settings_menu_preview(self) -> discord.Embed:
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                f"**Menu Categories**\n"
                f"{divider1}\n"
                f"{alliance_icon} **Alliance Operations**\n"
    ...
    def build_changes_preview(self) -> discord.Embed:
        ...
        # Chief's Office level change example
        embed.add_field(
            name=f"{user_icon} FrostWarrior",
            value=f"{stove_old_icon} `Lv. 5` ➜ {stove_icon} `Lv. 6`\n{time_icon} Just now",
            inline=False
        )
    ...
    def build_member_info_preview(self) -> discord.Embed:
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                f"{alliance_icon} **Alliance:** Really Cool Alliance\n"
                f"{stove_icon} **Chief's Office:** Lv. 8\n"
    ...
    def build_player_lookup_preview(self) -> discord.Embed:
        ...
        thumbnail for level content. This preview helps users see how
        ...
        embed = discord.Embed(
            ...
            description=(
                f"{divider1}\n"
                f"**{fid_icon} ID:** `123456789`\n"
                f"**{level_icon} Chief's Office Level:** `Lv. 12`\n"
        ...
        # Thumbnail would be the level image
