 ...
 * Building Calculator and whatever joins it later), not just a dead end
 * with nothing to do but sign in. */
export default function Login() {
  ...
  return (
    <Layout title="Sign in">
      <Card className="mx-auto flex max-w-sm flex-col items-center gap-3 py-10 text-center">
        <span className="text-4xl" aria-hidden="true">
          🛡️
        </span>
        <h2 className="text-xl font-semibold">Police Chief Dashboard</h2>
        <p className="mb-1 text-sm text-slate-500">Manage your alliance, right from the browser.</p>
        <a
          href={LOGIN_URL}
