...
from harness_attendance import parsers, vault_track
...
def test_fallback_recovers_cyrillic_name(monkeypatch):
    ...
    monkeypatch.setattr(vault_track, "ocr_bytes_with_boxes", fake_boxes)
...
def test_no_fallback_langs_configured(monkeypatch):
    ...
    monkeypatch.setattr(vault_track, "ocr_bytes", fake_ocr)
